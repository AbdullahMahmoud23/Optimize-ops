    ...
    <div className="relative min-h-screen bg-gradient-to-br from-white via-gray-50 to-gray-100 px-4 py-6 sm:px-6 lg:px-8 overflow-hidden overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
          {/* Total Supervisors */}
          <div className="stats bg-gradient-to-r from-blue-50 to-blue-100/50 border border-blue-200 shadow-md hover:shadow-lg transition-all rounded-xl">
            <div className="stat flex items-center justify-between gap-4">
              <div>
                ...
                <div className="stat-value text-3xl sm:text-5xl font-bold text-blue-700">
                  12
                </div>
              </div>
              <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-blue-200 flex items-center justify-center">
                <svg
          ...
          <div className="card-body">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              ...
              <button
                ...
                className="btn bg-gradient-to-r from-blue-700 to-blue-500 border-none text-white btn-md sm:btn-lg gap-3 hover:scale-[1.02] transition-transform shadow-lg hover:shadow-blue-400/40 rounded-lg w-full"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6"
                ...
                >
                  <path
                    ...
                    11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 
                    011-1z"
                    clipRule="evenodd"
                  />
                </svg>
                <div className="text-left">
                  <div className="font-bold">Add New Supervisor</div>
                  <div className="text-xs opacity-80">Create a new account</div>
                </div>
              </button>
              ...
              >
                ...
                >
                  ...
                  <path
                    ...
                    2.943 9.542 7c-1.274 4.057-5.064 
                    7-9.542 7S1.732 14.057.458 
                    10zM14 10a4 4 0 11-8 0 4 4 
                    0 018 0z"
                    clipRule="evenodd"
                  />
                </svg>
                <div className="text-left">
                  <div className="font-bold">View All Supervisors</div>
